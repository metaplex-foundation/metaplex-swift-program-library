 ...
 * @category generated
 */
public struct VerifySizedCollectionItemInstructionArgs{
    let instructionDiscriminator: [UInt8] /* size: 8 */
    

    public init(
        instructionDiscriminator: [UInt8] /* size: 8 */ = verifySizedCollectionItemInstructionDiscriminator
    ) {
 ...
 * @category generated
 */
public let VerifySizedCollectionItemStruct = FixableBeetArgsStruct<VerifySizedCollectionItemInstructionArgs>(
    fields: [
        ("instructionDiscriminator", Beet.fixedBeet(.init(value: .collection(UniformFixedSizeArray<UInt8>(element: .init(value: .scalar(u8())), len: 8))))),
        
    ],
    description: "VerifySizedCollectionItemInstructionArgs"
)
/**
...
* @category generated
*/
public struct VerifySizedCollectionItemInstructionAccounts {
...
public let verifySizedCollectionItemInstructionDiscriminator = [86, 111, 223, 68, 17, 99, 180, 147] as [UInt8]
...
* @category generated
*/
public func createVerifySizedCollectionItemInstruction(accounts: VerifySizedCollectionItemInstructionAccounts, 
programId: PublicKey=PublicKey(string: "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s")!) -> TransactionInstruction {

    let data = VerifySizedCollectionItemStruct.serialize(
            instance: ["instructionDiscriminator": verifySizedCollectionItemInstructionDiscriminator ])
