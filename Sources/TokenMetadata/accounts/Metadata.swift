...
public protocol MetadataArgs {
     ...
     var programmableConfig: COption<ProgrammableConfig> { get }
}
...
public struct Metadata: MetadataArgs {
  ...
  public let programmableConfig: COption<ProgrammableConfig>
  ...
  public static func fromArgs(args: Args) -> Metadata {
    return Metadata(
        ...
        programmableConfig: args["programmableConfig"] as! COption<ProgrammableConfig>
    )
  }
  /**
  ...
  public func serialize() -> ( Foundation.Data, Int ) {
    return metadataBeet.serialize(instance: [
        ...
        "programmableConfig" : self.programmableConfig
        ])
  }
  /**
...
static func getMinimumBalanceForRentExemption(
  ...
  public let metadataBeet = FixableBeetStruct<Metadata>(
    fields:[
        ...
        ("programmableConfig", Beet.fixableBeat(coption(inner: programmableConfigBeetWrapped)))
    ],
