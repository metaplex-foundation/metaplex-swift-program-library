...
public protocol UseauthorityrecordArgs {
    var useAuthorityRecordDiscriminator: [UInt8] { get }
     var key: Key { get }
...
public struct Useauthorityrecord: UseauthorityrecordArgs {
  public static let useAuthorityRecordDiscriminator = [227, 200, 230, 197, 244, 198, 172, 50] as [UInt8]

  public let useAuthorityRecordDiscriminator: [UInt8]
  public let key: Key
  ...
  public static func fromArgs(args: Args) -> Useauthorityrecord {
    return Useauthorityrecord(
        useAuthorityRecordDiscriminator: args["accountDiscriminator"] as! [UInt8],
        key: args["key"] as! Key,
  ...
  public func serialize() -> ( Foundation.Data, Int ) {
    return useAuthorityRecordBeet.serialize(instance: Useauthorityrecord(useAuthorityRecordDiscriminator : self.useAuthorityRecordDiscriminator,
        key : self.key,
