...
public protocol CandymachineArgs {
    var candyMachineDiscriminator: [UInt8] { get }
     var version: AccountVersion { get }
     var tokenStandard: UInt8 { get }
     var features: [UInt8] /* size: 6 */ { get }
     var authority: PublicKey { get }
     var mintAuthority: PublicKey { get }
     var collectionMint: PublicKey { get }
...
public struct Candymachine: CandymachineArgs {
  ...
  public let version: AccountVersion
  public let tokenStandard: UInt8
  public let features: [UInt8] /* size: 6 */
  public let authority: PublicKey
  public let mintAuthority: PublicKey
  public let collectionMint: PublicKey
  ...
  public static func fromArgs(args: Args) -> Candymachine {
    return Candymachine(
        ...
        version: args["version"] as! AccountVersion,
        tokenStandard: args["tokenStandard"] as! UInt8,
        features: args["features"] as! [UInt8] /* size: 6 */,
        authority: args["authority"] as! PublicKey,
        mintAuthority: args["mintAuthority"] as! PublicKey,
        collectionMint: args["collectionMint"] as! PublicKey,
  ...
  public func serialize() -> ( Foundation.Data, Int ) {
    return candyMachineBeet.serialize(instance: [
        ...
        "collectionMint" : self.collectionMint,
...
static func getMinimumBalanceForRentExemption(
  ...
  public let candyMachineBeet = FixableBeetStruct<Candymachine>(
    fields:[
        ...
        ("version", accountVersionBeetWrapped),
        ("tokenStandard", Beet.fixedBeet(.init(value: .scalar(u8())))),
        ("features", Beet.fixedBeet(.init(value: .collection(UniformFixedSizeArray<UInt8>(element: .init(value: .scalar(u8())), len: 6))))),
        ("authority", Beet.fixedBeet(.init(value: .scalar(BeetPublicKey())))),
        ("mintAuthority", Beet.fixedBeet(.init(value: .scalar(BeetPublicKey())))),
        ("collectionMint", Beet.fixedBeet(.init(value: .scalar(BeetPublicKey())))),
