...
public struct ExecuteSaleInstructionArgs{
    ...
    public init(
        instructionDiscriminator: [UInt8] /* size: 8 */ = executeSaleInstructionDiscriminator,
...
public let executeSaleInstructionDiscriminator = [37, 74, 217, 157, 79, 49, 35, 6] as [UInt8]
