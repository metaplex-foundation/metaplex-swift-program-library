...
public struct AuctioneerBuyInstructionArgs{
    ...
    public init(
        instructionDiscriminator: [UInt8] /* size: 8 */ = auctioneerBuyInstructionDiscriminator,
...
public let auctioneerBuyInstructionDiscriminator = [17, 106, 133, 46, 229, 48, 45, 208] as [UInt8]
