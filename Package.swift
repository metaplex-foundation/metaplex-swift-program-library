...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/metaplex-foundation/beet-swift", branch: "1.0.2"),
        .package(url: "https://github.com/metaplex-foundation/solita-swift.git", branch: "1.0.2")
    ],
    targets: [
